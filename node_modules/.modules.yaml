...
hoistedDependencies:
  ...
  '@next-auth/prisma-adapter@1.0.7(@prisma/client@5.22.0(prisma@6.15.0(typescript@5.9.2)))(next-auth@4.24.11(@auth/core@0.34.2(nodemailer@6.10.1))(next@15.0.0(@babel/core@7.28.4)(@playwright/test@1.55.1)(babel-plugin-macros@3.1.0)(react-dom@19.2.0(react@19.2.0))(react@19.2.0))(nodemailer@6.10.1)(react-dom@19.2.0(react@19.2.0))(react@19.2.0))':
  ...
  '@testing-library/react@16.3.0(@testing-library/dom@10.4.1)(@types/react-dom@19.2.1(@types/react@19.1.11))(@types/react@19.1.11)(react-dom@19.2.0(react@19.2.0))(react@19.2.0)':
  ...
  '@vitejs/plugin-react@5.0.4(vite@7.1.9(@types/node@20.19.19)(jiti@2.6.1)(terser@5.44.0)(tsx@4.20.6)(yaml@2.8.1))':
  ...
  apps/admin:
    '@everpath/admin': private
  apps/critters-web:
    '@atluxia/critters-web': private
  apps/everpath-admin:
    '@atluxia/everpath-admin': private
  apps/everpath-web:
    '@atluxia/everpath-web': private
  apps/nomad-web:
    '@atluxia/nomad-web': private
  apps/polyverse-web:
    '@atluxia/polyverse-web': private
  apps/unified-webapp:
    '@atluxia/unified-webapp': private
  apps/web:
    '@everpath/web': private
  arch@2.2.0:
    arch: private
  arg@5.0.2:
    arg: private
  ...
  packages/auth:
    '@atluxia/auth': private
  packages/config:
    '@atluxia/config': private
  packages/contracts:
    '@atluxia/contracts': private
  packages/contracts-marketplace:
    '@atluxia/contracts-marketplace': private
  packages/core:
    '@atluxia/core': private
  packages/database:
    '@atluxia/database': private
  packages/db:
    '@atluxia/db': private
  packages/env-config:
    '@atluxia/env-config': private
  packages/everpath-tsconfig:
    '@atluxia/everpath-tsconfig': private
  packages/everpath-ui:
    '@atluxia/everpath-ui': private
  packages/nomad-config:
    '@atluxia/nomad-config': private
  packages/opengrid-client:
    '@atluxia/opengrid-client': private
  packages/rules:
    '@atluxia/rules': private
  packages/schemas:
    '@atluxia/schemas': private
  packages/truth-archive-js:
    '@atluxia/truth-archive-js': private
  packages/tsconfig:
    '@everpath/tsconfig': private
  packages/ui:
    '@atluxia/ui': private
  pako@2.1.0:
    pako: private
  ...
  services/activitypub-bridge:
    '@atluxia/activitypub-bridge': private
  services/booking:
    '@atluxia/booking': private
  services/critters-api:
    '@atluxia/critters-api': private
  services/drivers:
    '@atluxia/drivers': private
  services/immigration:
    '@atluxia/immigration': private
  services/integration:
    '@atluxia/integration': private
  services/opengrid:
    '@atluxia/opengrid': private
  services/relay-node:
    '@atluxia/relay-node': private
  services/truth-agent:
    '@atluxia/truth-agent': private
  services/truth-graph:
    '@atluxia/truth-graph': private
  services/vehicles:
    '@atluxia/vehicles': private
...
injectedDeps:
  packages/pvp-sdk-js:
    - node_modules/.pnpm/@atluxia+pvp-sdk-js@file+packages+pvp-sdk-js/node_modules/@atluxia/pvp-sdk-js
layoutVersion: 5
nodeLinker: isolated
packageManager: pnpm@9.15.9
pendingBuilds: []
prunedAt: Mon, 06 Oct 2025 05:27:29 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
